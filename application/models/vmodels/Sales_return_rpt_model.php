    ...
    public function queryComplete($data, $sorder_by="a.fst_salesreturn_no", $rptLayout="1") {
        ...
        switch($rptLayout) {
            case "1":
                ...
                a.fst_memo as Retur_Memo,a.fdc_dpp_amount as Dpp,a.fdc_ppn_amount as Ppn,a.fdc_subttl as fdc_subttl,a.fdc_total as fdc_total,a.fdc_disc_amount as Disc_Total,a.fdc_potongan as Potongan_Total,a.fst_curr_code as Mata_Uang,a.fdc_exchange_rate_idr as Rate_Idr,
                ...
                b.fin_rec_id as Rec_Id, b.fin_item_id as Item_Id, f.fst_item_code as Item_Code, f.fst_item_name as Item_Name,b.fst_unit as Unit,
                b.fdb_qty as Qty,b.fdb_qty_lpb as Qty_Terima, b.fst_unit as Unit, b.fdc_price as Price,(b.fdc_price - b.fdc_disc_amount_per_item) as Price_Netto, b.fst_disc_item as Disc_Item, b.fdc_disc_amount_per_item as Disc_Amount,b.fdc_potongan as Potongan_Item,
                (b.fdb_qty * (b.fdc_price - b.fdc_disc_amount_per_item) - b.fdc_potongan) as Amount  
            ...
            case "2":
                ...
                a.fst_memo as Retur_Memo,a.fdc_dpp_amount as Dpp,a.fdc_ppn_amount as Ppn,a.fdc_subttl as fdc_subttl,a.fdc_total as fdc_total,a.fdc_disc_amount as Disc_Amount,a.fdc_potongan as fdc_potongan,a.fst_curr_code as Mata_Uang,a.fdc_exchange_rate_idr as Rate_Idr,
                ...
                break;
            case "3":
                $ssql = "SELECT a.fin_lpbsalesreturn_id,d.fst_inv_no as No_Inv,d.fdt_inv_datetime as Inv_Date, a.fst_lpbsalesreturn_no as No_Penerimaan, a.fdt_lpbsalesreturn_datetime as Penerimaan_Date,a.fst_memo as Penerimaan_Memo,
                a.fin_customer_id as fin_customer_id,c.fst_relation_name as Relation_Name, d.fin_sales_id as Sales_Id, e.fst_username as Sales_Name,
                b.fin_rec_id as Rec_Id, b.fin_item_id as Item_Id, f.fst_item_code as Item_Code, f.fst_item_name as Item_Name,b.fst_unit as Unit,b.fdb_qty as Qty,g.fst_salesreturn_no,g.fst_lpbsalesreturn_id_list AS List_Penerimaan
                FROM (SELECT * FROM trlpbsalesreturn WHERE fst_active !='D') a LEFT OUTER JOIN trlpbsalesreturnitems b 
                on a.fin_lpbsalesreturn_id = b.fin_lpbsalesreturn_id LEFT OUTER JOIN msrelations c
                on a.fin_customer_id = c.fin_relation_id LEFT OUTER JOIN trinvoice d
                on b.fin_inv_id = d.fin_inv_id LEFT OUTER JOIN users e
                on d.fin_sales_id = e.fin_user_id LEFT OUTER JOIN msitems f
                on b.fin_item_id = f.fin_item_id LEFT OUTER JOIN trsalesreturn g
                on JSON_SEARCH(g.fst_lpbsalesreturn_id_list,'one',a.fin_lpbsalesreturn_id) IS NOT NULL  $swhere ORDER BY a.fin_lpbsalesreturn_id";
                break;
            default:
                break;
        }
