...
class Trsalespreorder_model extends MY_Model{
    ...
    {
        $ssql = "select a.*,b.fst_item_maingroup_name,c.fst_item_group_name,d.fst_item_subgroup_name,e.fst_item_name,f.fst_curr_name from " . $this->tableName . " a 
        ...
        left join msitems e on a.fin_item_id = e.fin_item_id
        left join mscurrencies f on a.fst_curr_code = f.fst_curr_code
