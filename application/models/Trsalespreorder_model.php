...
class Trsalespreorder_model extends MY_Model{
    ...
    {
        $ssql = "select a.*,b.fst_item_maingroup_name,c.fst_item_group_name,d.fst_curr_name from " . $this->tableName . " a 
        ...
        left join mscurrencies d on a.fst_curr_code = d.fst_curr_code
