...
class Trcbreceiveother_model extends MY_Model {
	...
	public function posting($finCBReceiveOthId){
		...
		//log kasbank no
		$this->kasbanknumbering_model->log($dataH->fst_cbreceiveoth_no);
	...
	public function getDataVoucher($finCBReceiveOthId){
		$ssql ="SELECT a.*,
			b.fst_kasbank_name,
			d.fst_curr_name 
			FROM trcbreceiveother a
			INNER JOIN mskasbank b on a.fin_kasbank_id = b.fin_kasbank_id 
