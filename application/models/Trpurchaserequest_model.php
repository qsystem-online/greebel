...
class Trpurchaserequest_model extends MY_Model {
    ...
    public function getItemProcessList($itemType,$lineBusinessId){
        //5 logistic ; other merchandise



        $ssql ="SELECT a.*,b.fst_pr_no,b.fin_req_department_id,d.fst_department_name as fst_req_department_name,b.fdt_pr_datetime,c.fst_item_code,c.fst_item_name FROM trpurchaserequestitems a 
            ...
            WHERE b.fdt_publish_datetime IS NOT NULL AND
            a.fin_po_id IS null AND
