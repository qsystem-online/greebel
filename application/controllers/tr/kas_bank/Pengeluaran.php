...
class Pengeluaran extends MY_Controller{
	...
	public function index(){
        ...
        $this->list['columns'] = [
            ...
            ['title' => 'Tanggal', 'width' => '50px', 'data' => 'fdt_cbpayment_datetime'],
            ['title' => 'Supplier', 'width' => '150px', 'data' => 'fst_supplier_name'],		
			['title' => 'Memo', 'width' => '130px', 'data' => 'fst_memo'],
			['title' => 'Currency', 'width' => '50px', 'data' => 'fst_curr_code'],
			['title' => 'Total Amount', 'width' => '60px', 'data' => 'fdc_total_payment','className'=>'text-right',
