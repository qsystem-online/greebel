...
class Prefix_cash_bank extends MY_Controller {
    ...
    public function lizt(){
        ...
        $this->list['columns'] = [
            ...
            ['title' => 'Kas/Bank Name', 'width' => '10%', 'data' => 'fst_kasbank_name'],
            ['title' => 'Prefix Pengeluaran', 'width' => '15%', 'data' => 'fst_prefix_pengeluaran'],
            ['title' => 'Prefix Pemasukan', 'width' => '15%', 'data' => 'fst_prefix_pemasukan'],
            ['title' => 'Type', 'width' => '10%', 'data' => 'fst_type'],
            ['title' => 'GL Account Code', 'width' => '10%', 'data' => 'fst_gl_account_code'],
    ...
    public function openForm($mode = 'ADD', $fin_kasbank_id = 0){
		...
		$page_content = $this->parser->parse('pages/gl/config/prefix_cash_bank/form', $data, true);
		$main_footer = $this->parser->parse('inc/main_footer', [], true);
