...
class Invoice_netto extends MY_Controller
{

	public $menuName="report_invoice_netto";
	...
	public function __construct()
	{
		...
		$this->load->model('vmodels/invoice_netto_rpt_model');
		...
		$this->layout_columns = [
			...
			['layout' => 1, 'label'=>'No.S/J', 'value'=>'4', 'selected'=>false,'sum_total'=>false],
			...
			['layout' => 1, 'label'=>'Pelanggan/Customer', 'value'=>'8', 'selected'=>false,'sum_total'=>false],
			['layout' => 1, 'label'=>'M.U', 'value'=>'9', 'selected'=>false,'sum_total'=>true],
			['layout' => 1, 'label'=>'Nilai Faktur', 'value'=>'10', 'selected'=>false,'sum_total'=>false],
			['layout' => 1, 'label'=>'Total Retur', 'value'=>'11', 'selected'=>false,'sum_total'=>false],
			['layout' => 1, 'label'=>'Pembayaran', 'value'=>'12', 'selected'=>false,'sum_total'=>true],
			...
			['layout' => 2, 'label'=>'No.S/J', 'value'=>'4', 'selected'=>false,'sum_total'=>false],
			['layout' => 2, 'label'=>'No.S/O', 'value'=>'5', 'selected'=>false,'sum_total'=>false],
			['layout' => 2, 'label'=>'GUD', 'value'=>'6', 'selected'=>false,'sum_total'=>false],
			['layout' => 2, 'label'=>'Sales', 'value'=>'7', 'selected'=>false,'sum_total'=>false],
			['layout' => 2, 'label'=>'Pelanggan/Customer', 'value'=>'8', 'selected'=>false,'sum_total'=>false],
			['layout' => 2, 'label'=>'M.U', 'value'=>'9', 'selected'=>false,'sum_total'=>true],
			['layout' => 2, 'label'=>'Nilai Faktur', 'value'=>'10', 'selected'=>false,'sum_total'=>false],
			['layout' => 2, 'label'=>'Total Retur', 'value'=>'11', 'selected'=>false,'sum_total'=>false],
			['layout' => 2, 'label'=>'Pembayaran', 'value'=>'12', 'selected'=>false,'sum_total'=>true],
			['layout' => 2, 'label'=>'Nilai Netto', 'value'=>'13', 'selected'=>false,'sum_total'=>true],
			...
			['layout' => 3, 'label'=>'No.S/J', 'value'=>'4', 'selected'=>false,'sum_total'=>false],
			['layout' => 3, 'label'=>'No.S/O', 'value'=>'5', 'selected'=>false,'sum_total'=>false],
			['layout' => 3, 'label'=>'GUD', 'value'=>'6', 'selected'=>false,'sum_total'=>false],
			['layout' => 3, 'label'=>'Sales', 'value'=>'7', 'selected'=>false,'sum_total'=>false],
			['layout' => 3, 'label'=>'Pelanggan/Customer', 'value'=>'8', 'selected'=>false,'sum_total'=>false],
			['layout' => 3, 'label'=>'M.U', 'value'=>'9', 'selected'=>false,'sum_total'=>true],
			['layout' => 3, 'label'=>'Nilai Faktur', 'value'=>'10', 'selected'=>false,'sum_total'=>false],
			['layout' => 3, 'label'=>'Total Retur', 'value'=>'11', 'selected'=>false,'sum_total'=>false],
			['layout' => 3, 'label'=>'Pembayaran', 'value'=>'12', 'selected'=>false,'sum_total'=>true],
			['layout' => 3, 'label'=>'Nilai Netto', 'value'=>'13', 'selected'=>false,'sum_total'=>true],
	...
	public function loadForm()
	{
		...
		$side_filter = $this->parser->parse('reports/invoice_netto/form',$this->data, true);
		$this->data['REPORT_FILTER'] = $side_filter;
		$this->data['TITLE'] = "FAKTUR PENJUALAN NETTO REPORT";
		$mode = "Report";
		// $this->data["mode"] = $mode;
	...
	public function process()
	{
		...
		$this->load->model('invoice_netto_rpt_model');
		$this->form_validation->set_rules($this->invoice_netto_rpt_model->getRules());
	...
	public function generateReport($isPreview = 1){		
		...
		$dataReport = $this->invoice_netto_rpt_model->queryComplete($data,"b.fst_inv_no",$data['rpt_layout']);
		...
		switch ($data['rpt_layout']){
			case "1":
				$this->parser->parse('reports/invoice_netto/layout1', ["selectedCols"=>$selectedCols,"ttlCol"=>$totalColumn,"dataReport"=>$dataReport]);
				break;
			case "2":
				$this->parser->parse('reports/invoice_netto/layout2', ["selectedCols"=>$selectedCols,"ttlCol"=>$totalColumn,"dataReport"=>$dataReport]);
				break;
			case "3":
				$this->parser->parse('reports/invoice_netto/layout3', ["selectedCols"=>$selectedCols,"ttlCol"=>$totalColumn,"dataReport"=>$dataReport]);
				break;
			case "4":
				$this->parser->parse('reports/invoice_netto/layout4', ["selectedCols"=>$selectedCols,"ttlCol"=>$totalColumn,"dataReport"=>$dataReport]);
				break;
			case "5":
				$this->parser->parse('reports/invoice_netto/layout5', ["selectedCols"=>$selectedCols,"ttlCol"=>$totalColumn,"dataReport"=>$dataReport]);
				break;
			default:
				$this->parser->parse('reports/invoice_netto/layout1', ["selectedCols"=>$selectedCols,"ttlCol"=>$totalColumn,"dataReport"=>$dataReport]);
				break;
