...
class Purchase_order extends MY_Controller
{
	...
	public $menuName="report_purchase_order";
	...
	public function __construct()
	{
		...
		$this->layout_columns = [
			...
			['layout' => 1, 'label'=>'Jumlah IDR', 'value'=>'15', 'selected'=>false,'sum_total'=>true],
			...
			['layout' => 2, 'label'=>'DP', 'value'=>'13', 'selected'=>false,'sum_total'=>true],
			['layout' => 2, 'label'=>'DP Paid', 'value'=>'14', 'selected'=>false,'sum_total'=>true],
			['layout' => 2, 'label'=>'DP Claimed', 'value'=>'15', 'selected'=>false,'sum_total'=>true],
			...
			['layout' => 4, 'label'=>'No.P/O', 'value'=>'1', 'selected'=>false,'sum_total'=>false],
			['layout' => 4, 'label'=>'Tgl.P/O', 'value'=>'2', 'selected'=>false,'sum_total'=>false],
			['layout' => 4, 'label'=>'TOP', 'value'=>'3', 'selected'=>false,'sum_total'=>false],
			['layout' => 4, 'label'=>'GUD', 'value'=>'4', 'selected'=>false,'sum_total'=>false],
			['layout' => 4, 'label'=>'No.DO', 'value'=>'5', 'selected'=>false,'sum_total'=>false],
			['layout' => 4, 'label'=>'No.Kontrak', 'value'=>'6', 'selected'=>false,'sum_total'=>false],
			['layout' => 4, 'label'=>'Supplier', 'value'=>'7', 'selected'=>false,'sum_total'=>false],
			['layout' => 4, 'label'=>'M.U', 'value'=>'8', 'selected'=>false,'sum_total'=>true],
			['layout' => 4, 'label'=>'Rate', 'value'=>'9', 'selected'=>false,'sum_total'=>false],
			['layout' => 4, 'label'=>'Subtotal', 'value'=>'10', 'selected'=>false,'sum_total'=>false],
            ['layout' => 4, 'label'=>'Total', 'value'=>'11', 'selected'=>false,'sum_total'=>true],
			['layout' => 4, 'label'=>'Total IDR', 'value'=>'12', 'selected'=>false,'sum_total'=>true],
			['layout' => 4, 'label'=>'DP', 'value'=>'13', 'selected'=>false,'sum_total'=>true],
            ['layout' => 4, 'label'=>'Terbayar', 'value'=>'14', 'selected'=>false,'sum_total'=>true],
