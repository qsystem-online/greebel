...
class Sales_order extends MY_Controller
{
    ...
    public function loadForm()
    {
        ...
        $layout_columns = [['layout' => 1, 'label'=>'Nou.', 'value'=>'A', 'selected'=>true],
                        ['layout' => 1, 'label'=>'No.SO', 'value'=>'B', 'selected'=>true],
                        ['layout' => 1, 'label'=>'Tgl.SO', 'value'=>'C', 'selected'=>true],
                        ['layout' => 1, 'label'=>'Pelanggan', 'value'=>'D', 'selected'=>true],
                        ['layout' => 1, 'label'=>'Sales', 'value'=>'E', 'selected'=>true],
                        ['layout' => 1, 'label'=>'Kode Barang', 'value'=>'F', 'selected'=>true],
                        ['layout' => 1, 'label'=>'Nama Barang', 'value'=>'G', 'selected'=>true],
                        ['layout' => 1, 'label'=>'Qty', 'value'=>'H', 'selected'=>true],
                        ['layout' => 1, 'label'=>'Unit', 'value'=>'I', 'selected'=>true],
                        ['layout' => 1, 'label'=>'Harga', 'value'=>'J', 'selected'=>true],
                        ['layout' => 1, 'label'=>'Diskon', 'value'=>'K', 'selected'=>true],
                        ['layout' => 1, 'label'=>'Jumlah', 'value'=>'L', 'selected'=>true],
                        ['layout' => 2, 'label'=>'Nou.', 'value'=>'A', 'selected'=>true],
                        ['layout' => 2, 'label'=>'No.SO', 'value'=>'B', 'selected'=>true],
                        ['layout' => 2, 'label'=>'Tgl.SO', 'value'=>'C', 'selected'=>true],
                        ['layout' => 2, 'label'=>'Pelanggan', 'value'=>'D', 'selected'=>true],
                        ['layout' => 2, 'label'=>'Sales', 'value'=>'E', 'selected'=>true],
                        ['layout' => 2, 'label'=>'Nilai SO', 'value'=>'F', 'selected'=>true]
                        ];
        ...
        $this->data["layout_columns"] = $layout_columns;
