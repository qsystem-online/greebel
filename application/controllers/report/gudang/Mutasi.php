...
class Mutasi extends MY_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('vmodels/trmutasi_stock_rpt_model');
		$this->load->model('mswarehouse_model');

		$this->layout_columns = [
            ['layout' => 1, 'label'=>'No.', 'value'=>'0', 'selected'=>false,'sum_total'=>false],
			['layout' => 1, 'label'=>'No.MAG', 'value'=>'1', 'selected'=>false,'sum_total'=>false],
			['layout' => 1, 'label'=>'Tgl MAG', 'value'=>'2', 'selected'=>false,'sum_total'=>false],
			...
			['layout' => 2, 'label'=>'No.MAG', 'value'=>'1', 'selected'=>false,'sum_total'=>false],
			...
			['layout' => 2, 'label'=>'Qty MAG', 'value'=>'8', 'selected'=>false,'sum_total'=>false],
			['layout' => 2, 'label'=>'Qty PAG', 'value'=>'9', 'selected'=>false,'sum_total'=>false],
			['layout' => 2, 'label'=>'Unit', 'value'=>'9', 'selected'=>false,'sum_total'=>false],

            ['layout' => 3, 'label'=>'No.', 'value'=>'0', 'selected'=>false,'sum_total'=>false],
			['layout' => 3, 'label'=>'No.MAG', 'value'=>'1', 'selected'=>false,'sum_total'=>false],
			['layout' => 3, 'label'=>'Tanggal', 'value'=>'2', 'selected'=>false,'sum_total'=>false],
			['layout' => 3, 'label'=>'Gud. Asal', 'value'=>'3', 'selected'=>false,'sum_total'=>false],
			['layout' => 3, 'label'=>'Gud. Tujuan', 'value'=>'4', 'selected'=>false,'sum_total'=>false],
			['layout' => 3, 'label'=>'Memo', 'value'=>'5', 'selected'=>false,'sum_total'=>false],
	...
	public function loadForm()
	{
		...
		$side_filter = $this->parser->parse('reports/mutasi/form',$this->data, true);
		$this->data['REPORT_FILTER'] = $side_filter;
		$this->data['TITLE'] = "MAG REPORT";
		$mode = "Report";
		// $this->data["mode"] = $mode;
	...
	public function process()
	{
		...
		$this->load->model('trmutasi_stock_rpt_model');
		$this->form_validation->set_rules($this->trmutasi_stock_rpt_model->getRules());
	...
	public function generateReport($isPreview = 1){		
		...
		//$dataReport = $this->trmutasi_stock_rpt_model->queryComplete($data,$data['rpt_layout']);
		$dataReport = $this->trmutasi_stock_rpt_model->queryComplete($data,"c.fin_mag_id",$data['rpt_layout']);
		...
		switch ($data['rpt_layout']){
			case "1":
				$this->parser->parse('reports/mutasi/layout1', ["selectedCols"=>$selectedCols,"ttlCol"=>$totalColumn,"dataReport"=>$dataReport]);
				break;
			case "2":
				$this->parser->parse('reports/mutasi/layout2', ["selectedCols"=>$selectedCols,"ttlCol"=>$totalColumn,"dataReport"=>$dataReport]);
				break;
			case "3":
				$this->parser->parse('reports/mutasi/layout3', ["selectedCols"=>$selectedCols,"ttlCol"=>$totalColumn,"dataReport"=>$dataReport]);
				break;
			case "4":
				$this->parser->parse('reports/mutasi/layout4', ["selectedCols"=>$selectedCols,"ttlCol"=>$totalColumn,"dataReport"=>$dataReport]);
				break;
			case "5":
				$this->parser->parse('reports/mutasi/layout5', ["selectedCols"=>$selectedCols,"ttlCol"=>$totalColumn,"dataReport"=>$dataReport]);
				break;
			case "6":
				$this->parser->parse('reports/mutasi/layout6', ["selectedCols"=>$selectedCols,"ttlCol"=>$totalColumn,"dataReport"=>$dataReport]);
				break;
			default:
				$this->parser->parse('reports/mutasi/layout1', ["selectedCols"=>$selectedCols,"ttlCol"=>$totalColumn,"dataReport"=>$dataReport]);
				break;
