...
<html>
	<head>		
		...
		<link rel="stylesheet" href="<?=base_url()?>plugins/bootstrap-multiselect/css/bootstrap-multiselect.css">
	...
	<body class="hold-transition skin-blue sidebar-mini <?= $sidebarCollapse?>" style="overflow-x:auto">
		...
		<!-- Bootstrap Multiselect -->
		<script src="<?=base_url()?>plugins/bootstrap-multiselect/js/bootstrap-multiselect.js"></script>
