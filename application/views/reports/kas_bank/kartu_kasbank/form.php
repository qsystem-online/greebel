...
<!-- form start -->
<form id="rptKasBank" action="<?= site_url() ?>report/kas_bank/Kartu_kasbank/process" method="POST" enctype="multipart/form-data">
    <div class="box-body">
        <input type="hidden" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>">                    
            ...
            <div class="form-group row">						
                ...
                <div class="col-sm-4">
                    ...
                    <?php
                        $accountList = $this->glaccounts_model->getKasbankList();
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">								
                    <label class="radio"><input type="radio" id="rpt_layout1" class="rpt_layout" name="rpt_layout" value="1" checked onclick="handleRadioClick(this);"><?=lang("Laporan Kartu Kas/Bank")?></label>
                </div>
...
<script type="text/javascript">
    ...
    $(function() {
        $("#btnProcess").click(function(event) {
            ...
            data = $("#rptKasBank").serializeArray();
            url = "<?= site_url() ?>report/kas_bank/kartu_kasbank/process";
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    if (resp.status == "VALIDATION_FORM_FAILED") {
                        ...
                        url = "<?= site_url() ?>report/kas_bank/kartu_kasbank/generatereport";
                        //alert(url);
                        //$("iframe").attr("src",url);
                        $("#rptKasBank").attr('action', url);
                        $("#rptKasBank").attr('target', 'rpt_iframe');
                        $("#rptKasBank").submit();
        ...
        $("#btnExcel").click(function(event) {
			...
			a.download = 'Laporan_Kartu_Kas/Bank' + '.xls';
			a.click();                        			
			return;
		});      
    });
