<html>
	...
	<body id="bodyReport">
		...
		<div>LAPORAN TRANSAKSI DAN PEMBAYARAN EKSPEDISI</div>
		<br>
		<?php
			...
			<thead>
				<tr style="background-color:RoyalBlue;color:white">
					<?php
                        ...
                        echoIfColSelected(6,$selectedCols,"<th class='col-6' style='width:50px'>Qty(Kodi)</th></th>");
                        echoIfColSelected(7,$selectedCols,"<th class='col-7' style='width:50px'>Harga/Kodi</th>");
                        echoIfColSelected(8,$selectedCols,"<th class='col-8' style='width:50px'>Ppn</th>");
                        echoIfColSelected(9,$selectedCols,"<th class='col-9' style='width:100px'>No.Faktur Pajak</th>");
                        echoIfColSelected(10,$selectedCols,"<th class='col-10' style='width:50px'>Lain2</th>");
                        echoIfColSelected(11,$selectedCols,"<th class='col-11' style='width:100px'>Total</th>");
                        echoIfColSelected(12,$selectedCols,"<th class='col-12' style='width:50px'>AR</th>");
                        echoIfColSelected(13,$selectedCols,"<th class='col-13' style='width:100px'>S/J</th>");
					?>
				</tr>
			</thead>
			<tbody>
				<?php
					...
					foreach ($dataReport as $row){
                        ...
                        if ($Id_Ekspedisi != $row->Id_Ekspedisi){
                            ...
                            echoIfColSelected(6,$selectedCols,"<td class='col-6'style='text-align: right'>$qty_kodi</td>");
                            echoIfColSelected(7,$selectedCols,"<td class='col-7'style='text-align: right'>$price_kodi</td>");
                            echoIfColSelected(8,$selectedCols,"<td class='col-8'style='text-align: right'>$Ppn</td>");
                            echoIfColSelected(9,$selectedCols,"<td class='col-9'>$row->No_Pajak</td>");
                            echoIfColSelected(10,$selectedCols,"<td class='col-10'style='text-align: right'>$fdc_other_cost</td>");
                            echoIfColSelected(11,$selectedCols,"<td class='col-11'style='text-align: right'>$fdc_total</td>");
                            echoIfColSelected(12,$selectedCols,"<td class='col-12'style='text-align: center'>$row->Reclaimable</td>");	
                            ...
                            echoIfColSelected(8,$selectedCols,"<td class='col-8'style='text-align: right'></td>");
                            echoIfColSelected(9,$selectedCols,"<td class='col-9'></td>");
                            echoIfColSelected(10,$selectedCols,"<td class='col-10'style='text-align: right'></td>");
                            echoIfColSelected(11,$selectedCols,"<td class='col-11'style='text-align: right'></td>");
                            echoIfColSelected(12,$selectedCols,"<td class='col-12'style='text-align: center'></td>");
                        }
			            echoIfColSelected(13,$selectedCols,"<td class='col-13'>$row->No_SJ</td>");                                                                                                                                                  
						echo "</tr>";
                    ...
                    echoIfColSelected(6,$selectedCols,"<td class='col-6' style='font-weight: bold;text-align: right'>$ttl_qtyNew</td>");
