<html>
	...
	<body id="bodyReport">
		...
		<div>LAPORAN NILAI NETTO FAKTUR PENJUALAN RINGKAS PER-SALES</div>
		<br>
		<?php
				...
				<?php
					...
					foreach ($dataReport as $row){
						...
						if ( $idSales != $row->Sales_Id ){
							...
							echo "<tr>";
							echo "<td colspan='".totalSelectedCol(13,$selectedCols)."'style='text-align: left;font-weight: bold'>SALES : $row->Sales_Name</td>";
							echo "</tr>";	   
						}
						$nou++;
