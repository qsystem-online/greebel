<html>
	...
	<body id="bodyReport">
		...
		<div>LAPORAN NILAI NETTO FAKTUR PENJUALAN RINGKAS PER-CUSTOMER</div>
		<br>
		<?php
				...
				<?php
					...
					foreach ($dataReport as $row){
						...
						if ( $idCustomer != $row->Relation_Id ){
							...
							echo "<tr>";
							echo "<td colspan='".totalSelectedCol(13,$selectedCols)."'style='text-align: left;font-weight: bold'>CUSTOMER : $row->Relation_Name</td>";
							echo "</tr>";	   
						}
						$nou++;
