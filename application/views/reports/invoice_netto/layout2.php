<html>
	...
	<body id="bodyReport">
		...
		<div>LAPORAN NILAI NETTO FAKTUR PENJUALAN RINGKAS PER-GUDANG</div>
		<br>
		<?php
			...
			<tbody>
				<?php
					...
					foreach ($dataReport as $row){
						echo "<tr>";
						if ( $idWarehouse != $row->fin_warehouse_id ){
							if ($idWarehouse != "") {
									echo "<tr>";
							...
							$idWarehouse = $row->fin_warehouse_id;
							echo "<tr>";
							echo "<td colspan='".totalSelectedCol(17,$selectedCols)."'style='text-align: left;font-weight: bold'>GUDANG : $row->Warehouse</td>";
							echo "</tr>";	   
						}
						$nou++;
