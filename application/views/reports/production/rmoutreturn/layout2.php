<html>
	...
	<body id="bodyReport">
		...
		<div>LAPORAN RMOUT-RETURN</div>
		<br>
		<div>Tanggal system RMOUT-RETURN: <?= $this->input->post("fdt_datetime") ?>  s/d <?= $this->input->post("fdt_datetime2") ?></div>                             
			...
			<thead>
				<tr style="background-color:RoyalBlue;color:white">
					<?php
                        ...
                        echoIfColSelected(8,$selectedCols,"<th class='col-8' style='width:30px'>GUD</th>");
					?>
				</tr>
			</thead>
			<tbody>
				<?php
					...
					foreach ($dataReport as $row){
                        ...
                        echoIfColSelected(1,$selectedCols,"<td class='col-1'>$row->Return_Date</td>");
                        echoIfColSelected(2,$selectedCols,"<td class='col-2'>$row->Return_No</td>");
                        ...
                        echoIfColSelected(8,$selectedCols,"<td class='col-8'>$row->fst_warehouse_name</td>");									                                                                                                                                                                      
                        echo "</tr>";
					}
				?>
			</tbody>
