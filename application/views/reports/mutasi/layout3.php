			...
			<thead>
				<tr style="background-color:RoyalBlue;color:white">
					<?php
						...
						echoIfColSelected(1,$selectedCols,"<th class='col-1' style='width:50px'>No.MAG</th>");
						echoIfColSelected(2,$selectedCols,"<th class='col-2' style='width:50px'>Tgl.MAG</th>");
