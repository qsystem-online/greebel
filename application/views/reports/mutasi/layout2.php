<html>
	...
	<body id="bodyReport">
		...
		<div>LAPORAN MAG DETAIL OUTSTANDING PAG</div>
		<br>
        <?php
			...
			<thead>
				<tr style="background-color:RoyalBlue;color:white">
					<?php
						...
						echoIfColSelected(1,$selectedCols,"<th class='col-1' style='width:100px'>No.MAG</th>");
						echoIfColSelected(2,$selectedCols,"<th class='col-2' style='width:100px'>Tgl.MAG</th>");
						...
						echoIfColSelected(8,$selectedCols,"<th class='col-8' style='width:50px'>Qty MAG</th>");
                        echoIfColSelected(9,$selectedCols,"<th class='col-9' style='width:50px'>Qty PAG</th>");
			...
			<tbody>
				<?php
					...
					foreach ($dataReport as $row){
						echo "<tr>";
						if ( $idMAG != $row->fin_mag_id ){		
                            $idMAG = $row->fin_mag_id;
							$nou++;
                            echoIfColSelected(0,$selectedCols,"<td class='col-0'>$nou</td>");	   
                            echoIfColSelected(1,$selectedCols,"<td class='col-1'>$row->No_MAG</td>");
                            echoIfColSelected(2,$selectedCols,"<td class='col-2'>$row->MAG_Date</td>");
                            ...
                            echoIfColSelected(5,$selectedCols,"<td class='col-5'>$row->fst_memo</td>");
						}else{
						...
						$Qty_MAG = formatnumber($row->Qty_MAG,2);
						...
						echoIfColSelected(8,$selectedCols,"<td class='col-8' style='text-align: right'>$Qty_MAG</td>");
                        echoIfColSelected(9,$selectedCols,"<td class='col-9' style='text-align: right'>$Qty_PAG</td>");
