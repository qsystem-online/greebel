			...
			<thead>
				<tr style="background-color:RoyalBlue;color:white">
					<?php
                        ...
                        echoIfColSelected(6,$selectedCols,"<th class='col-6' style='width:100px'>Outstanding</th>");
                        echoIfColSelected(7,$selectedCols,"<th class='col-7' style='width:100px'>Pembayaran</th>");
                        echoIfColSelected(8,$selectedCols,"<th class='col-8' style='width:100px'>Selisih</th>");
                        echoIfColSelected(9,$selectedCols,"<th class='col-9' style='width:100px'>No.Pembayaran</th>");
                        echoIfColSelected(10,$selectedCols,"<th class='col-10' style='width:100px'>Tgl.Pembayaran</th>");
					?>
				</tr>
			</thead>
			<tbody>
				<?php
					...
					foreach ($dataReport as $row){
						...
						if ( $idCustomer != $row->Relation_Id ){
							if ($idCustomer != "") {
									...
									echoIfColSelected(6,$selectedCols,"<td class='col-6' style='font-weight: bold;text-align: right'>$sub_total_nettoNew</td>");
									echoIfColSelected(7,$selectedCols,"<td class='col-7' style='font-weight: bold;text-align: right'>$sub_total_paidNew</td>");
									echoIfColSelected(8,$selectedCols,"<td class='col-8' style='font-weight: bold;text-align: right'>$sub_total_outstandingNew</td>");
                        ...
                        if ($Id_Inv != $row->Id_Inv){
                            ...
                            echoIfColSelected(6,$selectedCols,"<td class='col-6'style='text-align: right'>$total_netto</td>");
                            echoIfColSelected(7,$selectedCols,"<td class='col-7'style='text-align: right'>$fdc_total_paid</td>");
                            echoIfColSelected(8,$selectedCols,"<td class='col-8'style='text-align: right'>$fdc_outstanding</td>");
                        ...
                        echoIfColSelected(9,$selectedCols,"<td class='col-9'>$row->Receive_No</td>");
                        echoIfColSelected(10,$selectedCols,"<td class='col-10'>$row->Receive_Date</td>");											                                                                                                                                                                      
						echo "</tr>";
					...
					echoIfColSelected(6,$selectedCols,"<td class='col-6' style='font-weight: bold;text-align: right'>$ttl_nilai_nettoNew</td>");
					echoIfColSelected(7,$selectedCols,"<td class='col-7' style='font-weight: bold;text-align: right'>$ttl_paidNew</td>");
					echoIfColSelected(8,$selectedCols,"<td class='col-8' style='font-weight: bold;text-align: right'>$ttl_outstandingNew</td>");
					echoIfColSelected(9,$selectedCols,"<td class='col-9' style='font-weight: bold;text-align: right'></td>");
                    echoIfColSelected(10,$selectedCols,"<td class='col-10' style='font-weight: bold;text-align: right'></td>");											
					echo "</tr>";
				?>
