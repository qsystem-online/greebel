			...
			<thead>
				<tr style="background-color:navy;color:white">
					<?php
						...
						echoIfColSelected(2,$selectedCols,"<th class='col-2' style='width:30px'>Trx Code</th>");
						...
						echoIfColSelected(8,$selectedCols,"<th class='col-8 text-right' style='width:50px'>Q.Sisa</th>");
						echoIfColSelected(9,$selectedCols,"<th class='col-9 text-right' style='width:30px'>Unit</th>");	
					?>
				</tr>
			</thead>
			<tbody>
