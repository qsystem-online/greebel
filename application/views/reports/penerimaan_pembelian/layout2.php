<html>
	...
	<body id="bodyReport">
		...
		<div>LAPORAN PENERIMAAN BARANG PEMBELIAN/ASSEMBLING PER-NO PENERIMAAN</div>
		<br>
		<?php
			...
			<thead>
				<tr style="background-color:RoyalBlue;color:white">
					<?php
						...
						echoIfColSelected(6,$selectedCols,"<th class='col-6' style='width:300px'>Supplier</th>");
						echoIfColSelected(7,$selectedCols,"<th class='col-7' style='width:100px'>No.Pembelian</th>");
						echoIfColSelected(8,$selectedCols,"<th class='col-8' style='width:100px'>Tgl.Pembelian</th>");
						echoIfColSelected(9,$selectedCols,"<th class='col-9' style='width:80px'>Kode Barang</th>");
                        echoIfColSelected(10,$selectedCols,"<th class='col-10' style='width:300px'>Nama Barang</th>");
				...
				<?php
					...
					foreach ($dataReport as $row){
						...
						if ( $Id_LpbGudang != $row->Id_LpbGudang ){
                            ...
                            echoIfColSelected(6,$selectedCols,"<td class='col-6'>$row->Supplier_Name</td>");
							if($row->Lpb_Type =='PO'){
                                ...
                                echoIfColSelected(8,$selectedCols,"<td class='col-8'>Assembling In</td>");
							}
						}else{
						...
						echoIfColSelected(11,$selectedCols,"<td class='col-11'style='text-align: right'>$Qty</td>");
