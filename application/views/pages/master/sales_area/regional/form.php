                ...
                <form id="frmSalRegional" class="form-horizontal" action="<?= site_url() ?>master/sales_area/add_regional" method="POST" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="fin_sales_regional_id" class="col-sm-3 control-label"><?=lang("Sales Regional ID")?> #</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="select-National" class="col-md-3 control-label"><?=lang("Sales National Name")?></label>
                            <div class="col-md-3">
...
<script type="text/javascript">
    $(function() {
		...
		$("#btnNew").click(function(e){
			e.preventDefault();
			window.location.replace("<?=site_url()?>master/sales_area/add_regional")
		});
		...
		$("#btnDelete").click(function(e){
			...
			$.ajax({
				url:"<?= site_url() ?>master/sales_area/delete/" + $("#fin_sales_regional_id").val(),
			}).done(function(resp){
				//consoleLog(resp);
				$.unblockUI();
				if (resp.message != "")	{
		...
		$("#btnList").click(function(e){
			e.preventDefault();
			window.location.replace("<?=site_url()?>master/sales_area/regional");
		});
    });
