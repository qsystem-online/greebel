                ...
                <form id="frmSalNational" class="form-horizontal" action="<?= site_url() ?>master/sales_area/add_national" method="POST" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class='form-group'>
                            <label for="fin_sales_national_id" class="col-sm-3 control-label"><?=lang("Sales National ID")?> #</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="select-salesId" class="col-md-3 control-label"><?=lang("Sales Name")?></label>
                            <div class="col-md-4">
