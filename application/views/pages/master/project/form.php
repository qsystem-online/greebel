                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right datepicker" id="fdt_project_start" name="fdt_project_start" />
                            </div>
                        ...
                        <div class="col-sm-3">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right datepicker" id="fdt_project_end" name="fdt_project_end" />
                            </div>
