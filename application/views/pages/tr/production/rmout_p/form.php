        ...
        <div class="col-md-12">
            ...
            <form id="frmHeader" class="form-horizontal" action="" method="POST" >
				<div class="box-body">
					...
					<input type="hidden" class="form-control" id="fin_rmout_id" placeholder="<?=lang("(Autonumber)")?>" name="fin_rmout_id" value="<?=$fin_rmout_id?>" readonly>

					
					<div class="form-group">
                        <label for="fst_rmout_no" class="col-md-2 control-label"><?=lang("RM-OUT No.")?> #</label>
						<div class="col-md-4">
							<input type="text" class="form-control" id="fst_mag_no" placeholder="<?=lang("RM-OUT No")?>" name="fst_rmout_no" value="<?=$fst_rmout_no?>" readonly>
							<div id="fst_rmout_no_err" class="text-danger"></div>
						</div>
						
						<label for="fdt_rmout_datetime" class="col-md-2 control-label"><?=lang("RM-OUT Date")?> *</label>
						<div class="col-md-4">
							<div class="input-group date">
								<div class="input-group-addon">
									<i class="fa fa-calendar"></i>
								</div>
								<input type="text" class="form-control text-right datetimepicker" id="fdt_rmout_datetime" name="fdt_rmout_datetime"/>
							</div>
							<div id="fdt_rmout_datetime_err" class="text-danger"></div>
							<!-- /.input group -->
						</div>						
                    </div>
	...
	<script type="text/javascript" info="init">
		$(function(){
			$("#d-fin_item_id").select2({
				...
				ajax:{
					delay: 250,
					url: "<?=site_url()?>tr/production/rmout/ajxGetItemList",
					dataType: 'json',
			...
			$("#d-fst_unit").select2({
				...
				ajax:{
					url: "<?=site_url()?>/tr/production/rmout/ajxGetUnits",
