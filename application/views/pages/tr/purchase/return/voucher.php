...
<div class='voucher content'>	
	...
	<div class="row">
		<div class="col" style="width:70%">
			...
			<div class="inline"><?=$header["fst_purchasereturn_no"]?></div>
		</div>		
		<div class="col" style="width:30%">
			<div class="inline first-col">Tanggal</div>			
			<div class="inline" style="width:15px">:</div>
			<div class="inline text-right"><?=date("d-M-Y",strtotime($header["fdt_purchasereturn_datetime"]))?></div>
		</div>
	</div>
	<div class="row">
		<div class="col" style="width:70%">
		...
		<div class="col" style="width:30%">
			<div class="inline first-col">Tanggal Faktur</div>
			<div class="inline" style="width:15px">:</div>
			<div class="inline text-right"><?=date("d-M-Y",strtotime($header["fdt_lpbpurchase_datetime"]))?></div>
		</div>
	</div>
	<div class="row">
