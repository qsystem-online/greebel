					...
					<div class="tab-content">
						<div id="formMaster" class="tab-pane fade in active" style="padding-top:20px">
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<select class="form-control" id="fin_lpbpurchase_id"></select>
								</div>					
								<label for="fst_fa_profile_name" class="col-md-1 control-label"><?=lang("Item")?> </label>			
								<div class="col-md-6">
									<select  class="form-control" id="fin_lpbpurchase_detail_id" name="fin_lpbpurchase_detail_id" ></select>
								</div>					
							</div>
...
<script type="text/javascript" info="event">
	$(function(){
		...
		$("#fin_lpbpurchase_detail_id").on("select2:select",function(e){
			...
			$("#fst_account_code").attr('disabled', true);

		}).on("select2:unselect",function(e){
			//$("#fst_account_code").select2("readonly", false);
			$("#fst_account_code").removeAttr('disabled');
		...
		$("#fdc_aquisition_price").focusin(function(e){
			console.log("focus",$("#fin_lpbpurchase_detail_id").val());

			if ($("#fin_lpbpurchase_detail_id").val() == null ){
				$("#fdc_aquisition_price").prop("readonly",0);
			}else{
				$("#fdc_aquisition_price").prop("readonly",1);
			}
		})
