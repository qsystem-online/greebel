...
<div class='voucher content'>	
	...
	<div class="row">
		<div class="col" style="width:70%">
			...
			<div class="inline"><?=$header["fst_cbreceiveoth_no"]?></div>
		</div>		
		<div class="col" style="width:30%">
			<div class="inline first-col2">Tanggal</div>			
			<div class="inline" style="width:15px">:</div>
			<div class="inline text-right"><?=date("d-M-Y",strtotime($header["fdt_cbreceiveoth_datetime"]))?></div>
		</div>
	</div>
	<div class="row">
		<div class="col" style="width:70%">
	...
	<div class="row">
		<div class="col" style="width:100%">
			<div class="inline first-col">Diterima Dari</div>
			<div class="inline" style="width:15px">:</div>
			<div class="inline"><?=$header["fst_receive_from"]?></div>
		</div>		
	</div>
	<div class="row">
		<div class="col" style="width:100%">
