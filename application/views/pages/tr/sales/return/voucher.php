...
<div class='voucher content'>	
	...
	<div class="row">
		<div class="col" style="width:70%">
			...
			<div class="inline"><?=$header["fst_salesreturn_no"]?></div>
		</div>		
		<div class="col" style="width:30%">
			<div class="inline" style="width:80px">Tanggal</div>			
			<div class="inline" style="width:15px">:</div>
			<div class="inline text-right"><?=date("d-M-Y",strtotime($header["fdt_salesreturn_datetime"]))?></div>
		</div>
	</div>
	<div class="row">
		<div class="col" style="width:70%">
	...
	<table class="table  table-condensed" style="width:100%;padding-bottom:0px">
		...
		<tbody>
			...
			<tr class="total">
				<td class="text-right" colspan="6">Sub Total (DPP) </td>
